...
export const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    description: 'PayPal REST API billing: one-time orders, monthly/yearly subscription plans, usage-based limits, refunds, HTML invoice generation, and webhook handler. Note: PayPal-only — if you need Razorpay (India), pair this with the PayPal Checkout block or adapt the patterns. INR display helpers included.',
    price: 39,
