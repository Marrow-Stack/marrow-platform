...
export const BLOCKS: Block[] = [
  {
    ...
    doduProductId:   'pdt_0Nb8jfeaDZHziZc3mrEZL',
  ...
  },
  {
    ...
    doduProductId:   'pdt_0Nb8jkgTzXGMANaonE5o4',
    complexity: 'Advanced',
    linesOfCode: 405,
    timeSavedHours: 18,
    deps: ['resend'],
...
if (limit.used >= limit.max) throw new Error('Upgrade required')`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8jqoL33n4LaJgAjwYk',
    complexity: 'Advanced',
    linesOfCode: 365,
    timeSavedHours: 14,
...
const flagEnabled = await isFeatureFlagEnabled('new_blocks_page', userId)`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8juEeNysswhhQ7gxiA',
    complexity: 'Beginner',
    linesOfCode: 302,
    timeSavedHours: 8,
    deps: ['resend'],
  ...
  },
  {
    ...
    doduProductId:   'pdt_0Nb8jxJDxCi2SAftg1K3v',
    complexity: 'Advanced',
    linesOfCode: 385,
    timeSavedHours: 16,
...
// → 'owner' | 'admin' | 'member' | 'viewer' | null`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8k05FeV4F8YCYiQ5d9',
    complexity: 'Intermediate',
    linesOfCode: 326,
    timeSavedHours: 10,
    deps: [],
...
// Throws if signature is invalid — blocks spoofed webhooks`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8k2VKnGsFCba3RU3iZ',
    complexity: 'Beginner',
    linesOfCode: 193,
    timeSavedHours: 6,
...
// Returns public signed URL, updates profiles.avatar_url`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8k4uyjHUxeKfOHpLEo',
    complexity: 'Intermediate',
    linesOfCode: 489,
    timeSavedHours: 10,
    deps: ['@supabase/supabase-js'],
...
await createNotification(supabaseAdmin, userId, {
  ...
  },
  {
    ...
    doduProductId:   'pdt_0Nb8k7GxHtW7S5AjJ85Js',
    complexity: 'Intermediate',
    linesOfCode: 327,
    timeSavedHours: 8,
    deps: ['@supabase/supabase-js'],
...
// results[0].highlight → '…code <b>authentication</b> flow with…'`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8k9wQaI1J7HAKjJGO4',
    complexity: 'Beginner',
    linesOfCode: 347,
    timeSavedHours: 6,
    deps: ['@supabase/supabase-js'],
...
/>`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kCLY0uhpXZP9JL4uK',
    complexity: 'Beginner',
    linesOfCode: 279,
    timeSavedHours: 5,
    deps: ['posthog-js'],
...
// usePageTracking() in providers.tsx auto-tracks all route changes`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kEaUg74smoLBpfv4E',
    complexity: 'Intermediate',
    linesOfCode: 228,
    timeSavedHours: 5,
...
// Automatic 429 + Retry-After on breach. X-RateLimit-* headers on all responses.`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kGklw17AfQIWZMjPC',
    complexity: 'Beginner',
    linesOfCode: 276,
    timeSavedHours: 5,
    deps: [],
...
if (err) return handleApiError(err)`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kJHtlvBcV6zQyG8xJ',
    complexity: 'Beginner',
    linesOfCode: 284,
    timeSavedHours: 4,
    deps: [],
...
<JsonLd schema={productJsonLd({ name: 'Auth System', description: '…', price: 19 })} />`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kMJLuJsZMc7ddw3OT',
    complexity: 'Intermediate',
    linesOfCode: 427,
    timeSavedHours: 8,
    deps: ['next-intl'],
...
// All 5 locales, RTL for Arabic, URL routing built-in`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kOfLDAUCQLCrRVR7j',
    complexity: 'Beginner',
    linesOfCode: 521,
    timeSavedHours: 8,
    deps: [],
...
<ThemedImage light="/logo-light.svg" dark="/logo-dark.svg" alt="Logo" />`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kSkGXdAxUxZboA0ID',
    complexity: 'Beginner',
    linesOfCode: 357,
    timeSavedHours: 5,
...
export const BUNDLES: Block[] = [
  {
    ...
    doduProductId:   'pdt_0Nb8kWD4hRbC09lg713NU',
    complexity:   'Advanced',
...
// Deploy-ready — just fill in .env.local`,
  },
  {
    ...
    doduProductId:   'pdt_0Nb8kZjlvUJRVeWcZcaxB',
    complexity:   'Intermediate',
